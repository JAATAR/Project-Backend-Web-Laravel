...
<main>
    <div class="page-content">
        ...
        <h1 class="faq_title">Update Category</h1>
    <div>
        <form action="{{url('edit_faq', $faq_category->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="div_center">
    <label for="">Category Title</label>
    <input type="text" name="title" value="{{$faq_category->title}}" >

    </div>
    <div class="div_center">
    <label for="">New Question</label>
    <input type="text" name="question" value="{{$faq_category->question}}">
   </div>
</div>
<div class="div_center">
<label for="">New Answer</label>
<input type="text" name="question" value="{{$faq_category->answer}}">
</div>
