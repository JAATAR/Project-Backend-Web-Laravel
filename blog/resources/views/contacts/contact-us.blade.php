...
.custom-form-position {
   ...
   <header class="intro-header" style="background-image: url('{{asset('img blades/contact-bg.jpg')}}')">
    <div class="container">
        <div class="row">
          ...
          <div class="md:w-2/5 md:ml-8 mx-auto md:mx-0 flex flex-col md:items-start">
            <div class="flex flex-col">
              <div class="relative flex items-end pb-12">
                <div class="-mr-1.5 mb-3 h-32 w-4 b"></div>
                <div class="-mr-1.5 mb-3 h-32 w-4" style="margin-bottom: -0.375rem; /* 3px */"></div>
              </div>
              <h2 class="text-4xl md:text-6xl lg:text-8xl font-bold mt-2 mb-4 duration-500 pl-5 pb-15">CONTACT US
              </h2>
            </div>
            ...
            <div class="w-full">
              ...
              <form method="POST" action="{{ route('contacts.store') }}" class="max-w-sm mx-auto">
                 ...
                 <label
                  ...
                  for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Full Name
                </label>
                <div class="flex">
                  <span
                  ...
                  <input type="text" id="naam" name="naam" value="{{ old('naam') }}"
                    class="form-control @error('naam') is-invalid @enderror rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 block flex-1 min-w-0 w-full text-sm p-2.5 "
                    placeholder="Kevin Felix" required autofocus> @error('naam') <span class="invalid-feedback"
                    role="alert">
                    <strong>{{ $message }}</strong>
                  </span> @enderror
                </div>
                <label for="email-address-icon"
                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-2">Your E-mail</label>
                <div class="relative">
                  <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">

                  </div>
                  <input type="email" id="email" name="email" value="{{ old('email') }}"
                    class="form-control @error('email') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5 "
                    placeholder="kevinFelix@student.ehb.be" required autofocus> @error('email') <span class="invalid-feedback"
                    role="alert">
                    <strong>{{ $message }}</strong>
                  </span> @enderror
                </div>
                <label for="bericht"
                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-5">Message</label>
                <textarea name="bericht" rows="4"
                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 mb-5"
                  placeholder="Write a message..." required>{{ old('bericht') }}</textarea> @error('bericht') <span
                  class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
                @enderror
                <button type="submit"
                  class="mx-auto focus:outline-none text-white bg-teal-500 hover:bg-red-500 focus:ring-4 focus:ring-red-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-500 dark:focus:ring-teal-500">Send</button>
              </form>
            </div>
            </div>
